"""Executive and summary report data for IndexTrace audits."""
...
def build_summary_report(
    ...
    """Translate an indexability verdict into an executive summary and actionable finding."""
...
build_human_report = build_summary_report
