...
def inspect_directives(
    ...
    if status_code != 200:
        canonical_status = "NON_200_RESPONSE"
        canonical_reason = f"Destination returned HTTP {status_code}; canonical cannot be established."
    elif not effective_canonical:
    ...
    is_noindex_active = (header_noindex or meta_noindex or header_none) if status_code == 200 else False
